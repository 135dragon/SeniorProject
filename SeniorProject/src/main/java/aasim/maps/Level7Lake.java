 ...
 * @author 14048
 */
public class Level7Lake extends Map {

    private String fileLocation = "resources/maps/Level7/Level7.jpg";
    private Map nextLevel = null;

    public Level7Lake(int x, int y) {
        super(x, y);
        setX(x);
        setY(y);
        spawnLocationX = 357;
    ...
    private void setSpawns() {
        for (int i = 0; i < 25; i++) {
            ...
            Piranha random = new Piranha(x, y, 75, 100);
            spawns.add(random);
        }
    }
