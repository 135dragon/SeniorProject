 ...
 * @author 14048
 */
public class Level14Grave extends Map {

    private String fileLocation = "resources/maps/Level14/Level14.jpg";
    private Map nextLevel = null;

    public Level14Grave(int x, int y) {
        super(x, y);
        setX(x);
        setY(y);
        spawnLocationX = 77;
