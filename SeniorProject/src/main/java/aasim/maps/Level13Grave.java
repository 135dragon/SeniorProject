 ...
 * @author 14048
 */
public class Level13Grave extends Map {

    private String fileLocation = "resources/maps/Level13/Level13.jpg";
    private Map nextLevel = null;

    public Level13Grave(int x, int y) {
        super(x, y);
        setX(x);
        setY(y);
        spawnLocationX = 77;
